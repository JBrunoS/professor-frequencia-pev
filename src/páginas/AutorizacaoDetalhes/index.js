      ...
      <div className="container-autorizacao">
        ...
        <div className="timeline">
          {timeline.map((t) => {
            ...
            if (t.acao === "RECUSADO" || t.aprovacao_status === "RECUSADO") {
            ...
            return (
              <div className="timeline-item" key={t.id}>
                ...
                <div className="content">
                  ...
                  <span>{t.acao}</span>
                  <small>
                    {t.usuario_nome} • {new Date(t.data_hora).toLocaleString()}
                  </small>
                  {t.aprovacao_observacao && (
                    <small style={{ fontStyle: "italic", color: "#f59f2eff" }}>
                      {t.aprovacao_observacao}
                    </small>
                  )}
                </div>
        ...
        {/* AÇÕES DO COMITÊ */}
        {role === "Comitê" && solicitacao.status === "AGUARDANDO_COMITE" && (
          <div className="acoes">
            <button
              className="aprovar"
        ...
        {(solicitacao.status === "FINALIZADO" ||
          ...
          <BotaoBaixarPDF solicitacaoId={solicitacao.id} />
        )}
      </div>
    </>
  );
